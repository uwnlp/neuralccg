package edu.uw.neuralccg.grammar;
...
public class NormalFormCustom extends NormalForm{
    @Override
    public boolean isOk(final RuleClass leftRuleClass, final RuleClass rightRuleClass, final RuleType ruleType,
                               final Category leftCategory, final Category rightCategory,
        ...
        if ((leftRuleClass == RuleClass.LP && ruleType != RuleType.RP && isPrefixOfSentence)
            ...
            // Remove left punctuation as late as possible.
            return false;
        }

        if (rightRuleClass == RuleClass.RP && leftRuleClass != RuleClass.LP) {
            // Remove right punctuation as late as possible.
            return false;
        }
